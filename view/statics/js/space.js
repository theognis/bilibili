...
tab_home.addEventListener('mouseout', () => moveUnderline(tab_underline_left))
tab_moments.addEventListener('mouseout', () => moveUnderline(tab_underline_left))
tab_post.addEventListener('mouseout', () => moveUnderline(tab_underline_left))
...
function moveUnderline(left) {
    tab_underline.style.left = left
}

function init(){
    if(location.pathname.split('/').length === 4){
        if(location.pathname.split('/')[3] === 'moments'){
            tab_underline_left = '96px'
        } else {
            tab_underline_left = '177px'
        }
    }
    moveUnderline(tab_underline_left)
}
